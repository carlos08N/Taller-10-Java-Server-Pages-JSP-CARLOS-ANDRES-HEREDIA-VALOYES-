...
<html>
    ...
    <body>
        <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <% 
                        ...
                        if("jonh".equals((String)session.getAttribute("usuario")) || "smith".equals((String)session.getAttribute("contraseña"))){
                            ...
                            out.println("<form class=\"d-flex\" action=\"Erdinger.jsp\">");
            ...
            <h1 class="h1 text-center">Erdinger</h1>
            <br><br><br><br><br>
            <div class="text-center">    
                <img src="IMG/Erdinger.jpg" alt="Imagen" style="width:500px; height:400px;">
            </div>       
            <br><br><br><br><br><br>
            <p class="h4 text-center">Erdinger es la cervecería de cerveza de trigo más grande del mundo. Está ampliamente disponible y es popular en Alemania y la Unión Europea. Erdinger fue fundada en 1886 por Johann Kienle.</p>
            ...
            <%
                if(ss==null){
                    ...
                    out.println("<div class=\"text-center\">\n" +
                                ...
                                "<br><br><br><br>\n" +
                                "<p class=\"h4 text-center\">Precio: 12.999</p>\n" +
                                "<br><br><br><br>\n" +
                                "");
                }
            %>
